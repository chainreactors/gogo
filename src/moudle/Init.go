	...
	if initparams.IPaddress == "" {
		fmt.Println(
			"Usage of ./getitle:" +
				...
				"\n     example ./getitle -ip 192.168.1.1/8 -p top2 -m s" +
				"\n  -p string        ports (default \"top1\")" +
				"\n     ports preset:   top1(default) 80,81,88,443,8080,7001,9001,8081,8000,8443" +
				"\n                     top2 80-90,137,443,7000-7009,9000-9009,8080-8090,8000-8009,8443,7080,8070,9080,8888,7777,9999,9090,800,801,808,5555,10080" +
				...
				"\n                     win 53,88,135,137,139,389,445,3389,5985" +
