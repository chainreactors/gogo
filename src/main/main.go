...
func main() {
	...
	ports := flag.String("port", "80,81,7001,9001,8080,8081,8000,8009,88,443,9999,7080,8070,9080,8082,8888,8089,5555", "ports")
	...
	IPAddress := flag.String("ip", "47.99.89.247/24", "IP地址 like 192.168.1.1/24")
	Mod := flag.String("m", "straight", "扫描模式：straight or smartB")

	banner := "********* designed by Insomnia(vidar Team), Getitle 0.0.2 beta  ********* "
