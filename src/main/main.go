...
func main() {
	...
	banner := "*********  Getitle 0.0.2 beta  ********* " +
		"\nUsage of ./getitle:\n  -d int\n        超时,默认2s (default 2)\n  -ip string\n        IP地址 like 192.168.1.1/24\n  -m string\n        扫描模式：straight or smartB (default \"straight\")\n  -p string\n        ports (default \"80,81,7001,9001,8080,8081,8000,8009,88,443,9999,7080,8070,9080,8082,8888,8089,5555\")\n  -t int\n        threads (default 4000)\n"
	...
	case "straight":
		//直接扫描
		moudle.StraightMod(*IPAddress, portlist, *Threads, *Delay)
	case "smartB":
		//启发式扫描
		moudle.SmartBMod(*IPAddress, portlist, *Threads, *Delay)
	}
