...
go-strip -f ./bin/getitle_windows_386_v%1.exe
go-strip -f ./bin/getitle_windows_amd64_v%1.exe
go-strip -f ./bin/getitle_linux_386_v%1
go-strip -f ./bin/getitle_linux_arm64_v%1
go-strip -f ./bin/getitle_linux_amd64_v%1
go-strip -f ./bin/getitle_darwin_amd64_v%1
